...
Source: Original
LastEditTime: 2023-11-08 03:19:41
'''
import os
import pywt
import math
...
class WiFi(Dataset):
    def __init__(self,data_file,gt_file=None,sampling_f=48,duration=300,buf=8,
        ...
        # self.amps = self.amps-np.mean(self.amps)
        # self.amps = self.amps/np.std(self.amps)
        ...
        # self.phases = self.phases-np.mean(self.phases)
        # self.phases = self.phases/np.std(self.phases)
